...
declare(strict_types=1); //Declaramos modo estricto
...
<body>
    <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link active text-success fw-bolder" aria-current="page" href="#">MI AGENDA</a>
        ...
        <section> <!-- seccion de imprimir todos los contactos -->
            <div class="row">
                <div class="col-12">
                    <h2 class="text-center  text-success mb-5">Agenda</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <?php echo printAgenda(); ?>
                </div>
            </div>
        </section>
        <!-- Footer -->
